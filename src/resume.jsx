...
const Resume = ({profPicture,email,name,university,skills,experince,jobTitle,location,linkedin,facebook,language2,level2,github,phone,education,startDate,endDate,language,level,projects,intrests}) =>{
    ...
    <>
            ...
            <div className='resume '>
                ...
                startDate={startDate} endDate={endDate} skills={skills}
                 ...
                 language={language} language2={language2} level2={level2} level={level} projects={projects} intrests={intrests} titleFontColor={titleFontColor} fullBodyColor={fullBodyColor} fullBodyFontColor={fullBodyFontColor} />
