        ...
        <div className='template2 mx-2'>
          <div className="row  pure-cv p-2" id="full_CV"style={{backgroundColor:`${bodyColor}`,color:`${bodyFontColor}`}}>
            ...
            <div className="col-6 one" >
              ...
              <h5 className="mt-4 " style={{color:`${headerColor}`,borderLeft:`10px solid ${headerColor}`,fontWeight:`bold`,paddingLeft:`10px`}}>Work Experience</h5>
                <p>{experience}</p>
                <p>{post}</p>
                <p>{startDate} - {endDate}</p>
                <p>descripton</p>
             
              <h4 className="mt-4" style={{color:`${headerColor}`,borderLeft:`10px solid ${headerColor}`,fontWeight:`bold`,paddingLeft:`10px`}}>Language</h4>
              ...
              <h4 className="mt-4" style={{color:`${headerColor}`,borderLeft:`10px solid ${headerColor}`,fontWeight:`bold`,paddingLeft:`10px`}}>Interests</h4>
                {[interests.split(',').map((interest,ind) =><span className={`mx-1 `} style={{border:`1px solid ${headerColor}`,borderRadius:`3px`,padding:'2px',color:`${headerColor}`}} key={ind}>{interests}</span>)]} 
            </div>

            <div className="col-6 mt-2 two px-3">
              <h4 className="mt-4 " style={{color:`${headerColor}`,borderLeft:`10px solid ${headerColor}`,fontWeight:`bold`,paddingLeft:`10px`}}>Skills</h4>
              {[skills.split(',').map((skill,ind) =><span className="mx-1 badge  bg-primary" key={ind}>{skill}</span>)]} 

              <h4 className="mt-5 " style={{color:`${headerColor}`,borderLeft:`10px solid ${headerColor}`,fontWeight:`bold`,paddingLeft:`10px`}}>Education</h4>
              <b>{faculty}</b> at {university} in {degree} <br />
              <p>{`${startUni} - ${endUni}`}</p>

              <h4 className="mt-4 " style={{color:`${headerColor}`,borderLeft:`10px solid ${headerColor}`,fontWeight:`bold`,paddingLeft:`10px`}}>Projects</h4>
